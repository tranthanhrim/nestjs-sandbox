...
import { CreateAccountUserDto, UpdateAccountUserDto } from '../dto/account-user.dto';
...
export class AccountUserService {
  ...
  async create(createAccountUserDto: CreateAccountUserDto): Promise<AccountUser> {
  ...
  async update(id: string, updateAccountUserDto: UpdateAccountUserDto): Promise<AccountUser | null> {
